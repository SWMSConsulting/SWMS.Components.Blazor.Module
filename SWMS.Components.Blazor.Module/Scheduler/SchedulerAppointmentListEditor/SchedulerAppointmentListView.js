...
var schedulerTbodySelector = " .dxbl-sc-table > tbody";
...
function initialize(firstGridSelector, secondGridSelector) {
    ...
    initializeCore(draggableElementContainer, firstGridSelector, secondGridSelector);
}
function initializeCore(draggableElementContainer, draggableGridSelector, droppableGridSelector) {
    var draggableSelector = draggableGridSelector + gridTbodySelector + " > tr[data-visible-index]";
    var droppableSelector = droppableGridSelector + schedulerTbodySelector + " > tr";
    ...
    $(function () {
        ...
        $(droppableSelector).droppable({
            ...
            drop: function (e, ui) {
                var schedulerIndex = e.target.rowIndex - 1;
                var listIndex = getRowVisibleIndex(ui.helper.prevObject[0]);
                dotNetHelper.invokeMethodAsync("MoveGridRow", listIndex, schedulerIndex);
            }
        });
    });
}
